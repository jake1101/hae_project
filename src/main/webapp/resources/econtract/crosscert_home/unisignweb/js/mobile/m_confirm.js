var __confirm = function( SANDBOX ) {
    var ConstructScreen = function( Param ) {   
        var __UIElement = {
            __Layout: function() {
                ...
                req.open('GET', SANDBOX.ESVS.SRCPath + 'unisignweb/rsrc/layout/mobile/m_confirm.html?version=' + SANDBOX.ver, false);
                req.send(null);
            ...
            __Lang: function() {
                ...
                req.open('GET', SANDBOX.ESVS.SRCPath + 'unisignweb/rsrc/lang/notice_' + SANDBOX.ESVS.Language + '.js?version=' + SANDBOX.ver, false);
                req.send(null);
        ...
        function WindowGenerate() {
            ...
            var titleLbl = document.getElementById('m-us-confirm-lbl-title');
            titleLbl.appendChild(document.createTextNode(__lang.IDS_NOTICE));
            
            var mainText = Param.args.msg;
            if ( mainText ) {
                var mainLbl = document.getElementById('m-us-confirm-lbl');
                mainLbl.innerHTML = mainText;
                mainLbl.setAttribute('tabindex', __TabIndex, 0);
            }

            var confirmBtn = document.getElementById('m-us-confirm-confirm-btn');
            ...
            var cancelBtn = document.getElementById('m-us-confirm-cancel-btn');
            ...
            var closeBtn = document.getElementById('m-us-confirm-cls-img-btn');
            closeBtn.setAttribute('tabindex', __TabIndex + 3, 0);
            closeBtn.onclick = function(){ WindowExit(); };
            
            var closeImg = document.getElementById('m-us-confirm-cls-btn-img');
            closeImg.setAttribute('alt', __lang.IDS_NOTICE_CLOSE, 0);
            closeImg.setAttribute('src', SANDBOX.ESVS.SRCPath + 'unisignweb/rsrc/img/mobile/m_x-btn.png', 0);
            
            return document.getElementById('m-us-div-confirm');
        }
