var __password = function( SANDBOX ) {
    var ConstructScreen = function( Param ) {   
        var __UIElement = {
            __Layout: function() {
                ...
                req.open('GET', SANDBOX.ESVS.SRCPath + 'unisignweb/rsrc/layout/mobile/m_password.html?version=' + SANDBOX.ver, false);
                req.send(null);
        ...
        function WindowConfirm( textObj ) {
            ...
            var passwdText = document.getElementById('m-us-password-input-textbox');
            if ( !passwdText.value ) {
            ...
            Param.onConfirm( passwdText.value );
            passwdText.value = '';
        ...
        function WindowGenerate() {
            ...
            var titleLbl = document.getElementById('m-us-password-lbl-title');
            titleLbl.appendChild(document.createTextNode(__lang.IDS_PASSWORD));
            
            var closeImg = document.getElementById('m-us-password-cls-btn-img');
            ...
            var certImg = document.getElementById('m-us-password-cert-img');
            certImg.setAttribute('src', SANDBOX.ESVS.SRCPath + 'unisignweb/rsrc/img/mobile/m_password-cert-img.png', 0);
            
            var notiLbl = document.getElementById('m-us-password-notice-text');
            notiLbl.appendChild(document.createTextNode(__lang.IDS_PASSWORD_NOTICE));
            
            var pwTextBox = document.getElementById('m-us-password-input-textbox');
            ...
            var cancelBtn = document.getElementById('m-us-password-cancel-btn');
            ...
            var closeBtn = document.getElementById('m-us-password-cls-btn');
            closeBtn.setAttribute('tabindex', __TabIndex + 3, 0);
            closeBtn.onclick = function(){ WindowExit(); };

            return document.getElementById('m-us-div-password');
        }
        ...
        function firstFocus() {
            ...
            if ( 0 < inputs.length ) {
                for ( var i = 0; i < inputs.length; i++ ) {
                    if ( 'm-us-password-input-textbox' == inputs[ i ].id ) {
                        inputs[ i ].focus();
                    }
                }
            }
