...
function initModule(crosscert) {
    ...
    function createArray(length) { // function shamelessly stolen from Yaffle's library https://github.com/Yaffle/BigInteger2
    ...
    function divMod2(a, b) { // Implementation idea shamelessly stolen from Silent Matt's library http://silentmatt.com/BigInteger2/
    ...
    SmallInteger.prototype.divmod = BigInteger2.prototype.divmod;
    ...
    SmallInteger.prototype.modPow = BigInteger2.prototype.modPow;
    ...
    BigInteger2.prototype.compare = function (v) {
        ...
        // https://github.com/peterolson/BigInteger2.js/issues/61
        if (v === Infinity) {
            return -1;
        }
        if (v === -Infinity) {
    ...
    SmallInteger.prototype.eq = SmallInteger.prototype.equals = BigInteger2.prototype.eq = BigInteger2.prototype.equals;

    BigInteger2.prototype.notEquals = function (v) {
        return this.compare(v) !== 0;
    };
    SmallInteger.prototype.neq = SmallInteger.prototype.notEquals = BigInteger2.prototype.neq = BigInteger2.prototype.notEquals;

    BigInteger2.prototype.greater = function (v) {
        return this.compare(v) > 0;
    };
    SmallInteger.prototype.gt = SmallInteger.prototype.greater = BigInteger2.prototype.gt = BigInteger2.prototype.greater;

    BigInteger2.prototype.lesser = function (v) {
        return this.compare(v) < 0;
    };
    SmallInteger.prototype.lt = SmallInteger.prototype.lesser = BigInteger2.prototype.lt = BigInteger2.prototype.lesser;

    BigInteger2.prototype.greaterOrEquals = function (v) {
        return this.compare(v) >= 0;
    };
    SmallInteger.prototype.geq = SmallInteger.prototype.greaterOrEquals = BigInteger2.prototype.geq = BigInteger2.prototype.greaterOrEquals;

    BigInteger2.prototype.lesserOrEquals = function (v) {
        return this.compare(v) <= 0;
    };
    SmallInteger.prototype.leq = SmallInteger.prototype.lesserOrEquals = BigInteger2.prototype.leq = BigInteger2.prototype.lesserOrEquals;
    ...
    SmallInteger.prototype.isDivisibleBy = BigInteger2.prototype.isDivisibleBy;
    ...
    BigInteger2.prototype.isPrime = function () {
    ...
    SmallInteger.prototype.isPrime = BigInteger2.prototype.isPrime;

    BigInteger2.prototype.isProbablePrime = function (iterations) {
        var isPrime = isBasicPrime(this);
        if (isPrime !== undefined) return isPrime;
        var n = this.abs();
    ...
    SmallInteger.prototype.isProbablePrime = BigInteger2.prototype.isProbablePrime;
    ...
    function shift_isSmall(n) {
        return ((typeof n === "number" || typeof n === "string") && +Math.abs(n) <= BASE) ||
            (n instanceof BigInteger2 && n.value.length <= 1);
    }
    ...
    SmallInteger.prototype.shiftLeft = BigInteger2.prototype.shiftLeft;
    ...
    SmallInteger.prototype.shiftRight = BigInteger2.prototype.shiftRight;
    ...
    SmallInteger.prototype.not = BigInteger2.prototype.not;

    BigInteger2.prototype.and = function (n) {
        return bitwise(this, n, function (a, b) { return a & b; });
    };
    SmallInteger.prototype.and = BigInteger2.prototype.and;

    BigInteger2.prototype.or = function (n) {
        return bitwise(this, n, function (a, b) { return a | b; });
    };
    SmallInteger.prototype.or = BigInteger2.prototype.or;

    BigInteger2.prototype.xor = function (n) {
        return bitwise(this, n, function (a, b) { return a ^ b; });
    };
    SmallInteger.prototype.xor = BigInteger2.prototype.xor;

    var LOBMASK_I = 1 << 30, LOBMASK_BI = (BASE & -BASE) * (BASE & -BASE) | LOBMASK_I;
    function roughLOB(n) { // get lowestOneBit (rough)
        // SmallInteger: return Min(lowestOneBit(n), 1 << 30)
        // BigInteger2: return Min(lowestOneBit(n), 1 << 14) [BASE=1e7]
    ...
    function randBetween(a, b) {
        ...
        return low.add(typeof result === "number" ? new SmallInteger(result) : new BigInteger2(result, false));
    }
    ...
    BigInteger2.prototype.toString = function (radix) {
    ...
    CACHE.gcd = gcd;
    CACHE.lcm = lcm;
    CACHE.isInstance = function (x) { return x instanceof BigInteger2 || x instanceof SmallInteger; };
    CACHE.randBetween = randBetween;
    
    crosscert.jsbn2 = crosscert.jsbn2 || {};
    crosscert.jsbn2.BigInteger2 = BigInteger2;   
    return CACHE;
...
if(typeof define !== 'function') {
  ...
  // <script>
    ...
    crosscert = window.crosscert = window.crosscert || {};
    initModule(crosscert);
  }
}
// AMD
if(nodeDefine || typeof define === 'function') {
  ...
  function(require, module) {
    module.exports = function(crosscert) {
      var mods = deps.map(function(dep) {
        return require(dep);
      }).concat(initModule);
      // handle circular dependencies
      crosscert = crosscert || {};
      crosscert.defined = crosscert.defined || {};
      if(crosscert.defined[name]) {
        return crosscert[name];
      }
      crosscert.defined[name] = true;
