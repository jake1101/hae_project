...
//document.write("<script type='text/javascript' charset= '" + "utf-8" + "' src='" + secukitnxBaseDir + "KICA/config/nxinterface.js'></script>");
//document.write("<script type='text/javascript' charset= '" + "utf-8" + "' src='" + secukitnxBaseDir + "KICA/config/nxproto_nxclient.js'></script>");
