...
<body class="messageWrap">
	<div class="container2">
	    ...
	    <div class="section">
	    	<div class="subject" style="width:330px !important"><b>404</b><span>에러<br/>Not Found</span></div>
	    	<p class="explan" style="width:380px !important">요청하신 페이지를 찾을 수 없습니다.  <br/>
	    		Page not found. The server can not find the requested file or script.</p>
	    	<p class="hr2"></p>
