...
public class WorkerSensorController {
	 ...
	 * @Date :2020. 01. 23
	 * @Method Name : findListWorkerOperation
	 */
	@AuthCheck (authCode = Const.READ)
	@RequestMapping(value = "findListWorkerOperation.do")
	public @ResponseBody List findListWorkerOperation(@RequestBody Map param) {
	 ...
	 * @param param the param
	 * @Date : 2020. 01. 23
	 * @Method Name : saveListWorkerOperation
	 */
	@AuthCheck(authCode=Const.SAVE)
	@RequestMapping(value = "saveListWorkerOperation.do")
	public @ResponseBody Map saveListWorkerOperation(@RequestBody Map param) {
	 ...
	 * @param param the param
	 * @Date : 2020. 01. 23
	 * @Method Name : saveCollect
	 */
	@AuthCheck(authCode=Const.SAVE)
	@RequestMapping(value = "saveCollect.do")
	public @ResponseBody Map saveCollect(@RequestBody Map param) {
		Map<String, Object> resultMap = new HashMap<String, Object>();
	...
	public @ResponseBody List findWorkerList(@RequestBody Map param) {
		...
		String customerUrl = URL + "/worker/list";
