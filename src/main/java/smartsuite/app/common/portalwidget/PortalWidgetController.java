...
public class PortalWidgetController {
	...
	public @ResponseBody List<Map<String, Object>> findListExchange(@RequestBody Map<String, Object> param) throws Exception {
		return portalWidgetService.findListExchange(param);
	}
	...
	public @ResponseBody Map<String, Object> updateListExchange(@RequestBody Map<String, Object> param) throws Exception {
		return portalWidgetService.updateListExchange(param);
	}
	 ...
	 */
	@RequestMapping(value="findListPoTotAmtTreeMon.do")
	public @ResponseBody List<Map<String, Object>> findListPoTotAmtTreeMon(@RequestBody Map<String, Object> param) {
		return portalWidgetService.findListPoTotAmtTreeMon(param);
	}
}
