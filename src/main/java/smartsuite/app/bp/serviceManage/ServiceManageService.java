...
//		List<Map<String, Object>> resultMap = new ArrayList<Map<String, Object>>();
	 ...
	 */
	public Map<String,Object> serviceSstListDetailChgDay(Map param) {
		...
		resultMap = restfulUtilServiceToCorners.callCornersApi("serviceSstListDetailChgDay", param);
	 ...
	 */
	public Map<String,Object> serviceSstListDetailChgFee(Map param) {
		...
		resultMap = restfulUtilServiceToCorners.callCornersApi("serviceSstListDetailChgFee", param);
