...
public class CommonException  extends RuntimeException{
	...
	/**
     * 지정된 message 와  client 에 전달할 result_status 문자열을 매개변수로 하는 {@code CommonException} 생성자
     *
     * @param message - logging 및 client 메세지 처리에 사용되며 다국어처리 대상
     * @param resultStatus - client 에 전달할 result_status 문자열
     */
	...
	public CommonException(ErrorCode errorCode) {
		...
		this.defaultMessage = errorCode.getDefalutMessage();
