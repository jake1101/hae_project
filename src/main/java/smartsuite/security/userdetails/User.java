...
public class User implements UserDetails {
	...
	List<Map<String,Object>> userOperOrgCodes;
	...
	public List<Map<String, Object>> getUserOperOrgCodes() {
		return userOperOrgCodes;
	}
	
	public void setUserOperOrgCodes(List<Map<String, Object>> userOperOrgCodes) {
		this.userOperOrgCodes = userOperOrgCodes;
	}
