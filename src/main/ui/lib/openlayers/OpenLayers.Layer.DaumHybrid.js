...
OpenLayers.Layer.DaumHybrid = OpenLayers.Class(OpenLayers.Layer.XYZ, {
    ...
    name: "DaumHybridMap",
    url: [ 
    	conf.map.daum.url0+"/map_hybrid_hd/1909dms/L${z}/${y}/${x}.png",
    	conf.map.daum.url1+"/map_hybrid_hd/1909dms/L${z}/${y}/${x}.png",
    	conf.map.daum.url2+"/map_hybrid_hd/1909dms/L${z}/${y}/${x}.png",
    	conf.map.daum.url3+"/map_hybrid_hd/1909dms/L${z}/${y}/${x}.png"
    ],
