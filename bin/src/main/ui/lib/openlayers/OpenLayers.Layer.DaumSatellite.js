...
OpenLayers.Layer.DaumSatellite = OpenLayers.Class(OpenLayers.Layer.XYZ, {
    ...
    url: [
    	conf.map.daum.url0+"/map_skyview_hd/L${z}/${y}/${x}.jpg",
    	conf.map.daum.url1+"/map_skyview_hd/L${z}/${y}/${x}.jpg",
    	conf.map.daum.url2+"/map_skyview_hd/L${z}/${y}/${x}.jpg",
    	conf.map.daum.url3+"/map_skyview_hd/L${z}/${y}/${x}.jpg"
    ],
