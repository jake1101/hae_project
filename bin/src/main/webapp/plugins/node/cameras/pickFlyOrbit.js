    ...
    function (glmat) {
        ...
        SceneJS.Types.addType("cameras/pickFlyOrbit", {
            ...
            construct: function (params) {
        		...
        		look = { x: 0, y: 0, z: 0 };
        		startPivot= null;
        		currentPivot = glmat.vec3.fromValues(look.x || 0, look.y || 0, look.z || 0);
                endPivot = glmat.vec3.fromValues(look.x || 0, look.y || 0, look.z || 0);
                ...
                eye = params.eye || { x: 0, y: 0, z: 0 };
                look = params.look || { x: 0, y: 0, z: 0};
...
//                                             label.setShown(false);
            ...
            moveTo : function (hit) {
                ...
                flightStartTime = null;
                flightDuration = 1000.0 * ((flightDist / 1000) + 1); // extra seconds to ensure arrival
                //this.__proto__.constructor.[[Scopes]][1].flying = true;
                flying = true;
            ...
            destruct: function () {
            	var scene = this.getScene();
            	scene.off(pickHandle);
            	scene.off(tickHandle);
            }
        });
