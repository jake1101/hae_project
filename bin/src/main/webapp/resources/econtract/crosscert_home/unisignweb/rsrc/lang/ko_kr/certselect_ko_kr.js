(function() {
	return {
		...
		IDS_MSGBOX_NOT_INSTALL_VESTCERT:					"공인인증서 이용 프로그램(exe)의 설치가 되지 않았습니다.\n설치페이지로 이동합니다.",
		// nhkim 20160308 - 스마트인증 프로그램 미 설치 및 update
		IDS_MSGBOX_NOT_INSTALL_SMARTCERT:					"스마트 공인인증 프로그램의 설치 및 업데이트가 필요합니다.설치페이지로 이동합니다.\n\n스마트 공인인증 프로그램의 설치가 완료되면 인증서 선택창에서 스마트인증을 선택 바랍니다.",
