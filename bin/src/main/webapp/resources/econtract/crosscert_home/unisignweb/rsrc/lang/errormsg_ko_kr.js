(function() {
    return {
    	IDS_CERT_LOADING_MSG:            ["인증서 목록을 불러오는 중입니다.", "전자서명 중입니다.", "인증서 폐지를 진행중입니다.", "인증서를 삭제하는 중입니다.", "인증서를 갱신하는 중입니다.", "인증서를 복사하는 중입니다.", 
    	                                  "인증서를 가져오는 중입니다.", "인증서를 내보내는 중입니다.", "비밀번호를 변경하는 중입니다.", "비밀번호를 확인하는 중입니다.", "전자봉투 생성 중입니다.", "전자봉투 검증 중입니다.", "인증서를 검증하는 중입니다."],
        ...
        IDS_ERROR_LOADING_NIMSERVIER:     "VestCert가  언로드 되었습니다.\n페이지 새로 고침을 하시거나 첫 페이지로 이동하셔서 재시도 해주십시오.",
        ...
        // nhkim 20151130
        IDS_NOALLOW_UPDATECERT: 		"인증서 갱신이 허가 되어 있지 않습니다. 해당 등록기관에 확인하신 후 갱신을 시도하여 주시기 바랍니다."
