...
<head>
	...
	<script type="text/javascript" src="/resources/econtract/crosscert_home/unisignweb/framework/json2.js" ></script>
	<script type="text/javascript" src="/resources/econtract/crosscert_home/install/ObjectInstall.js" ></script>
</head>
<body>
	...
	<script type="text/javascript">
		function fnDownload(){
			document.getElementById("us-downloadURL").src = '/resources/econtract/crosscert_home/install/UniSignCRSV3Setup.exe';
		}
		...
		var checker = UniCRSInstall({
			...
			success: function(){
				...
				document.dataForm.order.value = "after";
	...
	<form name="dataForm" method="post" action="/sp/edoc/contract/openCertSelectionPage.do">
		<input type="hidden" name="cntr_no"      value="${cntr_no}"/>
		<input type="hidden" name="cntr_rev"     value="${cntr_rev}"/>
		<input type="hidden" name="random_value" value="${random_value}"/>
		<input type="hidden" name="order"        value="after"/>
		<sec:csrfInput/>
	</form>
