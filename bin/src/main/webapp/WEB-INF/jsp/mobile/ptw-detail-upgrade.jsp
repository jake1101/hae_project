                  ...
                  <div class="box-body">
					...
					<div class="form-group">
						...
						<select class="_vendorWorkerCombo form-control select2 select2-hidden-accessible"
                     		data-placeholder="작업자를 선택해 주세요" id="reqWorkerJob2" name="reqWorkerJob2" style="width: 100%;" aria-hidden="true">
		                </select>
                     </div>
                     ...
                     <div class="form-group" id="workerCntDiv" style="display:none;">
                     	<label style="color:red">[필수] </label>
                     	<label>작업자 수</label>
                     	<input type="number" class="form-control" name="workerCnt" placeholder="작업 인원수를 입력해주세요">
                     </div>
                     
                     <div class="form-group" id="workerMinCountDiv" style="display:none;">
                     	<label style="color:red">[필수] </label>
                     	<label>최소 작업자 수</label>
                     	<input type="number" class="form-control" name="minWorkerCnt" placeholder="최소 작업 인원수를 입력해주세요">
                     </div>
...
<!--                      </div> -->
                     ...
                     <div class="form-group" id="reqWorkerJobDiv" style="display:none;">
                     	...
                     	<select class="_vendorWorkerCombo form-control select2 select2-hidden-accessible" multiple="multiple" 
                     		data-placeholder="작업자를 선택해 주세요" id="reqWorkerJob" name="reqWorkerJob" style="width: 100%;" aria-hidden="true">
         ...
         if(bResult){
            ...
            if(!gSts || gSts == "temp" || gSts == "request"){
               param = {
                  ...
                  // 2021-12-7 jh.Park 작업 책임자 추가 밑 피수 인력 배열 파라미터로 수정
                  ,repWorkerId : $("#reqWorkerJob2").val()
                  ,essWorkerList: $('#reqWorkerJob').val() // 필수 인력 : 작업자 아이디를 배열로
               };
