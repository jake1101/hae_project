    ...
    <section class="content">
      <!-- Default box -->
        <div class="box-body">
			...
			<div class="form-group">
				<div class="input-group">
		           	<span class="input-group-addon">JOBTYPE</span>
...
<!-- 			<div class="form-group"> -->
<!-- 					Please enter the largest number for automatic entry prevention -->
...
<!-- 			<div class="form-group"> -->
<!-- 				<div class="input-group"> -->
<!-- 		           	<span class="input-group-addon">The largest number</span> -->
        		...
        		try{
        			var resultList = data.body;
       				for(var i = 0 ; i < resultList.length ; i++){
   						if(i==0){
	       		             $('#vendorId').append( $("<option>Not selected</option>"));
        ...
        success: function(data) {  
        		try{
        			var resultList = data.body;
       				for(var i = 0 ; i < resultList.length ; i++){
       					if(i==0){
       		             $('#jobTypeId').append( $("<option>Not selected</option>"));
...
function onEnter()
{
		...
		if( $('#firstNum').val() == "" || $('#secNum').val() == "" || $('#thirdNum').val() == ""){
			alert("Phone number is a required value.");
			$('#secNum').focus();
			return;
		}
		
		if($('#vendorId').val() == "Not selected"){
			vendorId = null;
		}
		if($('#jobTypeId').val() == "Not selected"){
			jobTypeId = null;
		}
...
function onEnterConfirm(){
	...
	if( $('#birthdayYear').val() == "" || $('#birthdayMonth').val() == "" || $('#birthdayDay').val() == ""){
		alert("Date of birth is a required value.");
		$('#birthdayYear').focus();
		return;
	}
