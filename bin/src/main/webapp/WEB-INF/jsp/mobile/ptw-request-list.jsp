...
/* 		} */
	...
	td:nth-of-type(2):before { content: "제목"; color:#f9836d; background-color: #fdf0ed;width: 90px;}
	td:nth-of-type(3):before { content: "상태"; color:#f9836d; background-color: #fdf0ed;width: 90px;}
			}
	</style>
</head>
...
<!-- 	    				<h3 class="box-title">안전작업목록</h3> -->
						<div class="form-horizontal">
							...
							<div class="bottom_layout">
							  <button type="button" name="search" class="btn btn_new_resist w150" id="back" onclick="onNewReq()">신규신청</button>
							</div>
						</div>
